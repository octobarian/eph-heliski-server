  ...
  [@layout.head]
    <script>
      Prime.Document.onReady(function() {
        ...
        new FusionAuth.Admin.SearchForm(form, 'io.fusionauth.applications.advancedControls');
      });
    </script>
  [/@layout.head]
  [@layout.body]
    ...
    [@layout.main]
      [@panel.full]
        [@control.form id="application-form" action="${request.contextPath}/admin/application/" method="GET" class="labels-above full push-bottom" searchResults="application-content"]
          ...
          <div class="row push-lesser-top push-bottom">
            <div class="col-xs tight-left">
              ...
              [@button.iconLinkWithText href="/admin/application/?clear=true" color="blue" icon="undo" textKey="reset" class="reset-button" name='reset'/]
            </div>
          </div>
        [/@control.form]
